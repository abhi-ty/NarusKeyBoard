...
public class CandidateView extends View {
	...
	public CandidateView(Context context) {
		 ...
		 * float distanceX, float distanceY) { mScrolled = true; int sx =
		 * getScrollX(); sx += distanceX; if (sx < 0) { sx = 0; } if (sx +
		 * getWidth() > mTotalWidth) { sx -= distanceX; } mTargetScrollX = sx;
		 * scrollTo(sx, getScrollY()); invalidate(); return true; } });
		 */
